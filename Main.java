...
public class Main {
    ...
    public static void calc(String input) throws CalculatorException {
        ...
        if (resultSwitcher1 + resultSwitcher2 == 1) { throw new CalculatorException("Калькулятор умеет работать только с арабскими или римскими цифрами одновременно."); }
